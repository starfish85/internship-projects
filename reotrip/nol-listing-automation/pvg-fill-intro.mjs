...
const IMG_DIR = '/Users/mac/nol/upload-ready-images/shanghai-pudong-airport';
const IMAGES = ['pvg-1.jpg', 'pvg-2.jpg', 'pvg-3.jpg']
  .map((f) => path.join(IMG_DIR, f))
  .filter(fs.existsSync);
const CITY = '상하이 시내 호텔';
const DEST = '상하이 푸동국제공항(PVG)';
...
const INTRO = `이 서비스는 ${CITY}과 ${DEST}(上海浦东国际机场 / Shanghai Pudong International Airport) 사이의 편도 전용 차량 이동 서비스입니다.
