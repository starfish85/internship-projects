/**
 * 伊丹机场(ITM)-神户市区 时段 — Japan 07:00–21:30 ×30 via setTimesChina opts
 * usage: node ikb-fix-times.mjs <0|1|2|3>
 */
...
if (arg === undefined) {
  console.error('用法: node ikb-fix-times.mjs <optionIndex>');
  process.exit(2);
}

const JAPAN = { startHour: '07', startMin: '00', endHour: '21', endMin: '30', expectCount: 30 };

const { page } = await connectNolPage({ selfHint: 'ikb-fix-times', killPeers: true });
