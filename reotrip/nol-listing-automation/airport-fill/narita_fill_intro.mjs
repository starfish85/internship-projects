...
const imagePaths = [
  '/Users/mac/nol上架/upload-ready-images/narita-airport/narita-airport-1.jpg',
  '/Users/mac/nol上架/upload-ready-images/narita-airport/narita-airport-2.jpg',
  '/Users/mac/nol上架/upload-ready-images/narita-airport/narita-airport-3.jpg',
];

const headline = '도쿄 시내 호텔 ↔ 나리타공항(NRT) 편도 전용 차량으로 편안하게 이동하세요!';
const highlight = [
  '도쿄 시내 호텔과 나리타공항(NRT) 간 단독 차량 편도 이동',
  '대중교통 환승 없이 공항까지 편안한 픽업/샌딩 서비스',
  'WhatsApp 또는 SMS로 사전 연락 후 이용하는 프라이빗 공항 이동',
].join('\n');
const description = `이 서비스는 도쿄 시내 호텔과 나리타공항(NRT) 사이를 편도 전용 차량으로 이동하는 공항 픽업/샌딩 서비스입니다.
...
예약 시 도쿄 시내 호텔명/주소, 나리타공항(NRT) 터미널 및 승하차 또는 픽업 장소, 이용 시간, 연락 가능한 휴대전화 번호, 항공편 정보를 정확히 입력해 주세요.
...
- 예약 시 도쿄 시내 호텔명/주소, 나리타공항(NRT) 터미널 및 승하차 또는 픽업 장소, 이용 시간, 항공편 정보, 탑승 인원, 수하물 수량을 정확히 입력해 주세요.
...
const usage = `1. 예약 시 도쿄 시내 호텔명/주소, 나리타공항(NRT) 터미널 및 승하차 또는 픽업 장소, 이용 시간, 연락 가능한 휴대전화 번호, 항공편 정보를 정확히 입력해 주세요.
