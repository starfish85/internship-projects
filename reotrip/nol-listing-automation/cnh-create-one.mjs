/**
 * 铃鹿市区 创建单个选项（无时段）
 * usage: node cnh-create-one.mjs 7go|10go|7rtn|10rtn
 */
...
const HOTEL = '중부 국제공항(NGO)';
const DEST = '나고야 시내 호텔';
...
const OPT = MAP[key];
if (!OPT) {
  console.error('usage: node cnh-create-one.mjs 7go|10go|7rtn|10rtn');
  process.exit(2);
}

const sleep = (ms) => new Promise((r) => setTimeout(r, ms));
killPeerCdpScripts('cnh-create-one');
