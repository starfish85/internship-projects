/**
 * 吴淞口机场 WSK 属性：私人/主题/语言/POI/1-4 → 保存然后
 * DRAFT 2556123c-0f81-4ca3-9fdf-a2bb869c5fcd
 * §51 · §56 POI 真选中 · §55 逐步 log
 */
...
if (names.mgmt !== INTERNAL || names.max !== '4') failExit('name/capacity FAIL');
...
if (!gate.private || !gate.theme || !gate.lang || gate.max !== '4')
  failExit('attrs gate FAIL ' + JSON.stringify(gate));

// §56 POI 真验收 → 通过后才点「保存然后」
try {
