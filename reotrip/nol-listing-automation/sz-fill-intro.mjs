...
const DRAFT = process.env.SZ_DRAFT || readFileSync(join(__dir, '.sz-draft-id'), 'utf8').trim();
...
const IMG_DIR = '/Users/mac/nol/upload-ready-images/kyoto-suzuka';
const IMAGES = ['sz-1.jpg', 'sz-2.jpg', 'sz-3.jpg']
