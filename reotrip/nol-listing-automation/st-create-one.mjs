/**
 * 晴空塔 创建单个选项（无时段）
 * usage: node st-create-one.mjs 7go|10go|7rtn|10rtn
 */
...
const OPT = MAP[key];
if (!OPT) {
  console.error('usage: node st-create-one.mjs 7go|10go|7rtn|10rtn');
  process.exit(2);
}

const sleep = (ms) => new Promise((r) => setTimeout(r, ms));
killPeerCdpScripts('st-create-one');
