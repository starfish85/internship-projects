/**
 * 铃鹿市区 创建单个选项（无时段）
 * usage: node kb-create-one.mjs 7go|10go|7rtn|10rtn
 */
...
const HOTEL = '고베 시내 호텔';
const DEST = '간사이 국제공항(KIX)';
...
const OPT = MAP[key];
if (!OPT) {
  console.error('usage: node kb-create-one.mjs 7go|10go|7rtn|10rtn');
  process.exit(2);
}

const sleep = (ms) => new Promise((r) => setTimeout(r, ms));
killPeerCdpScripts('kb-create-one');
