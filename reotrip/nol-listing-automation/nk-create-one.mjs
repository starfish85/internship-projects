/**
 * 铃鹿市区 创建单个选项（无时段）
 * usage: node nk-create-one.mjs 7go|10go|7rtn|10rtn
 */
...
const OPT = MAP[key];
if (!OPT) {
  console.error('usage: node nk-create-one.mjs 7go|10go|7rtn|10rtn');
  process.exit(2);
}

const sleep = (ms) => new Promise((r) => setTimeout(r, ms));
killPeerCdpScripts('nk-create-one');
