/**
 * 铃鹿市区 创建单个选项（无时段）
 * usage: node htd-create-one.mjs 7go|10go|7rtn|10rtn
 */
...
const OPT = MAP[key];
if (!OPT) {
  console.error('usage: node htd-create-one.mjs 7go|10go|7rtn|10rtn');
  process.exit(2);
}

const sleep = (ms) => new Promise((r) => setTimeout(r, ms));
killPeerCdpScripts('htd-create-one');
