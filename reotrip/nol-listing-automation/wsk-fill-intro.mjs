 ...
 * DRAFT 2556123c-0f81-4ca3-9fdf-a2bb869c5fcd
 */
import fs from 'fs';
...
const IMG_DIR = '/Users/mac/nol/upload-ready-images/shanghai-wusongkou-port';
const IMAGES = ['wsk-1.jpg', 'wsk-2.jpg', 'wsk-3.jpg']
...
const INTRO = `이 서비스는 ${CITY}과 ${DEST}(上海吴淞口国际邮轮港 / Shanghai Wusongkou International Cruise Terminal) 사이의 편도 전용 차량 이동 서비스입니다.
...
예약 시 선박명·승하선 정보, 상하이 시내 호텔명/주소, 픽업 장소, 연락 가능한 휴대전화 번호, 탑승 인원, 수하물 수량을 정확히 입력해 주세요.
...
2.미팅 장소: 호텔 픽업 시 기사님이 호텔 로비에서 픽업해 드립니다. 동일한 이름의 호텔이 있을 수 있으므로 호텔 이름과 주소를 함께 제공해 주세요. 공항 픽업 시 터미널/승하선 장소를 정확히 입력해 주세요.
