/**
 * HSZ holidays 虹桥机场-火车站 — listClean per segment, element/text locators, verify 日\n价
...
const OPTS = [
  { label: '7go', oct: '500', spring: '700', may: '500' },
  { label: '7rtn', oct: '500', spring: '700', may: '500' },
];
const SEGS = [
...
const { page } = await connectNolPage({ selfHint: 'hsz-fix-holidays', killPeers: true });
