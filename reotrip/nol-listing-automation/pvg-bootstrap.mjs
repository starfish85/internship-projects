...
const PRODUCT_KO =
  '상하이 시내 호텔 ↔ 상하이 푸동국제공항(PVG) 단독 차량 편도 이동 서비스';
const INTERNAL = '上海市区酒店-上海浦东机场';
const sleep = (ms) => new Promise((r) => setTimeout(r, ms));

console.log('【将要】杀残留 CDP + 打开列表 创建/恢复 PVG 草稿');
killPeerCdpScripts('pvg-bootstrap');
...
if (
  ...
  /푸동국제공항|浦东机场|PVG/.test(body)
) {
  console.log('【将要】恢复草稿 浦东机场（排除虹桥/火车站）');
  const card = page
