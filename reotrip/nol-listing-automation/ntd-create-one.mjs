/**
 * 铃鹿市区 创建单个选项（无时段）
 * usage: node ntd-create-one.mjs 7go|10go|7rtn|10rtn
 */
...
const HOTEL = '나리타 공항(NRT)';
const DEST = '도쿄 디즈니 리조트';
...
const OPT = MAP[key];
if (!OPT) {
  console.error('usage: node ntd-create-one.mjs 7go|10go|7rtn|10rtn');
  process.exit(2);
}

const sleep = (ms) => new Promise((r) => setTimeout(r, ms));
killPeerCdpScripts('ntd-create-one');
