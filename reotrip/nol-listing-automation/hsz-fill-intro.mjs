...
const IMG_DIR = '/Users/mac/nol/upload-ready-images/hongqiao-airport-railway';
const IMAGES = ['hsz-1.jpg', 'hsz-2.jpg', 'hsz-3.jpg']
  .map((f) => path.join(IMG_DIR, f))
  .filter(fs.existsSync);
const CITY = '상하이 훙차오국제공항(SHA)';
const DEST = '상하이역';
...
const INTRO = `이 서비스는 ${CITY}과 ${DEST}(上海虹桥国际机场 / Shanghai Hongqiao International Airport ↔ Shanghai Railway Station) 사이의 편도 전용 차량 이동 서비스입니다.
