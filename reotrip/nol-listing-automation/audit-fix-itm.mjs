...
const PRODUCT_KO = '오사카 시내 호텔 ↔ 이타미공항(ITM) 단독 차량 편도 이동 서비스';
const PRODUCT_CN = '大阪市区-大阪国际机场（伊丹机场）(ITM)';
let PRODUCT_ID = process.env.ITM_ID || '88b3861b-e907-487b-bacb-5abcfc1a7988';
...
const OPTIONS = [
  {
    match: '오사카 시내 호텔 출발 → 이타미공항(ITM) 편도 이동 (7인승 차량)',
    fullName: '오사카 시내 호텔 출발 → 이타미공항(ITM) 편도 이동 (7인승 차량)',
    ptName: '7인승 가는',
    ptDesc: '7인승 차량',
    price: '77',
  },
  {
    match: '오사카 시내 호텔 출발 → 이타미공항(ITM) 편도 이동 (10인승 차량)',
    fullName: '오사카 시내 호텔 출발 → 이타미공항(ITM) 편도 이동 (10인승 차량)',
    ptName: '10인승 가는',
    ptDesc: '10인승 차량',
    price: '105',
  },
  {
    match: '이타미공항(ITM) 출발 → 오사카 시내 호텔 편도 이동 (7인승 차량)',
    fullName: '이타미공항(ITM) 출발 → 오사카 시내 호텔 편도 이동 (7인승 차량)',
    ptName: '7인승 오는',
    ptDesc: '7인승 차량',
    price: '77',
  },
  {
    match: '이타미공항(ITM) 출발 → 오사카 시내 호텔 편도 이동 (10인승 차량)',
    fullName: '이타미공항(ITM) 출발 → 오사카 시내 호텔 편도 이동 (10인승 차량)',
    ptName: '10인승 오는',
    ptDesc: '10인승 차량',
    price: '105',
  },
...
async function resolveProductId(page) {
  ...
  const clicked = await page.evaluate((names) => {
    ...
    return null;
  }, [PRODUCT_KO, '이타미공항(ITM)', PRODUCT_CN, '伊丹', '오사카 국제공항']);
...
async function audit(page) {
  ...
  report.titleOk = body.includes('이타미') || body.includes('伊丹') || body.includes('ITM');
...
async function main() {
  ...
  if (!okId) throw new Error('Cannot resolve ITM product id');
