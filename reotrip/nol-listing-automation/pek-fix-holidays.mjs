/**
 * PEK holidays — listClean per segment, element/text locators, verify 日\n价
 * 7go: 311 / 436 / 311 | 7rtn: 457 / 639 / 457
 * NEVER 提交审核
...
const OPTS = [
  { label: '7go', oct: '311', spring: '436', may: '311' },
  { label: '7rtn', oct: '457', spring: '639', may: '457' },
];
const SEGS = [
...
const { page } = await connectNolPage({ selfHint: 'pek-fix-holidays', killPeers: true });
