...
const data = JSON.parse(fs.readFileSync("data/port-transfers.json", "utf8"));
...
assert.equal(riskRows.length, 13, "generated RTRF data must retain all 13 frozen risk ids");
